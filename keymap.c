...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_TAB, KC_F11, KC_F12, XXXXXXX, XXXXXXX, XXXXXXX,                          XXXXXXX, XXXXXXX, KC_UP, XXXXXXX, XXXXXXX, KC_TRNS,
        KC_CAPS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS,
        KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS,     KC_TRNS, XXXXXXX, XXXXXXX, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_LCTL, KC_LGUI, KC_LALT, KC_TRNS, KC_SPC,                                 KC_ENT, KC_APP, KC_TRNS, KC_TRNS, KC_TRNS
    ),
    ...
    [0] =
        {
            ...
            ENCODER_CCW_CW(XXXXXXX, KC_MSTP)    // Encoder : Pista play/stop
        },
